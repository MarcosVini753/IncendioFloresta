...
> Para reproduzir os produtos consumidos pelo frontend, consulte
> [PRODUTOS_WEB.md](PRODUTOS_WEB.md). Este arquivo permanece como dicionário dos
> dados científicos de origem.
